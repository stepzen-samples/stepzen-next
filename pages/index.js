...
const API_ENDPOINT = "https://anant.stepzen.net/api/meetup/__graphql";
...
function Home({ customers }){
  ...
  */
  ...
  if (!showOrders.customerByEmail) return (
    <div className="container">
      <Head>
        <title>stepzen-next</title>
        <link rel="icon" href="/favicon.ico" />
      </Head>
      Sorry {customers.name}, we could not retrieve your orders. Can you provide us your email below?
      <form onSubmit={onSubmit}>
        ...
        />
        {errors.task && (
            <span role="alert">{errors.task.message}</span>
        )}
        </div>
        <div>
